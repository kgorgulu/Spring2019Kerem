...
public class Notes {
	public static void main(String[] args) {
		...
		getter -->> a method for getting the value of your field and the name is specifically recommended in getFieldName() format  and return the value of field

		setter -->> a method for setting the value of your field and the name specifically suggested to have 

...
public class WarmUpTaskGetSum {
	public static void main(String[] args) {
		...
		Create a static method getSum , accept 1 paramter as int array , and return the sum of the all the items in array

		another method called  addAll,  accept 1 paramter as String array , and return the concatenation of all items 

		another method called getMax , accept 1 paramter as int array, and return the max from the all the items in array
		 * Optional : 
